...
Here we create a nested memory router with a separate set of routes. When you navigate with this Preact sub-tree this router will be active, if the route isn't found the parent router will be used.

```js
import { useMemo } from "preact/hooks";
import { NestedRouter } from "@nano-router/preact";
import { createMemoryHistory } from "@nano-router/history";
...
import { usePrompt } from "@nano-router/preact";
